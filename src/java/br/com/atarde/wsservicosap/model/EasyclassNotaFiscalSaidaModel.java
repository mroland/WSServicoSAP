...
public class EasyclassNotaFiscalSaidaModel extends NotaFiscalSaidaABModel {
    ...
    public EasyclassNotaFiscalSaidaModel() {

    }

    public EasyclassNotaFiscalSaidaModel(String tipo, Long interfaceId) {
