...
public class ItemDAO {
	...
	public ItemModel obter(ItemModel model) {
        ...
        broker.setSQL("SELECT OITM.\"ItemCode\", OITM.\"InvntItem\", OITM.\"SellItem\", OITM.\"PrchseItem\" FROM "+ model.getEmpresaModel().getDbInstancia() + ".OITM WHERE OITM.\"ItemCode\" = ?", model.getId());
