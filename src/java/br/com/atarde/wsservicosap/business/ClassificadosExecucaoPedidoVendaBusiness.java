...
import br.com.atarde.wsservicosap.dao.ClassificadosExecucaoPedidoVendaDAO;
...
public class ClassificadosExecucaoPedidoVendaBusiness extends NotaFiscalSaidaBusiness {

    private StringBuilder info;

    private ClassificadosExecucaoNotaFiscalSaidaModel nota;

    public ClassificadosExecucaoPedidoVendaBusiness() {
    }

    public ClassificadosExecucaoPedidoVendaBusiness(ClassificadosExecucaoNotaFiscalSaidaModel model) {
    ...
    public String validar() {
        ...
        if (TSUtil.isEmpty(this.nota)) {
            ...
            if ("".equals(retorno.toString())) {
                ...
                if (!TSUtil.isEmpty(new ClassificadosExecucaoPedidoVendaDAO().obterIdExternoInterface(nota))) {
