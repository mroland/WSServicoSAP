 ...
 * @author mroland
 */
public class CobrancaNotaFiscalSaidaBusiness extends NotaFiscalSaidaBusiness {

    private StringBuilder info;
    private CobrancaNotaFiscalSaidaModel nota;

    public CobrancaNotaFiscalSaidaBusiness() {
    }

    public CobrancaNotaFiscalSaidaBusiness(CobrancaNotaFiscalSaidaModel model) {
    ...
    public String validar() {
        ...
        if (TSUtil.isEmpty(this.nota)) {
            ...
            if ("".equals(retorno.toString())) {
                ...
                if (!TSUtil.isEmpty(new CobrancaNotaFiscalSaidaDAO().obterIdExternoInterface(nota))) {
