...
import br.com.atarde.wsservicosap.dao.RadioPedidoVendaDAO;
...
public class RadioPedidoVendaBusiness extends NotaFiscalSaidaBusiness {

    private StringBuilder info;

    private RadioNotaFiscalSaidaModel nota;

    public RadioPedidoVendaBusiness() {
    }

    public RadioPedidoVendaBusiness(RadioNotaFiscalSaidaModel model) {
    ...
    public String validar() {
        ...
        if (TSUtil.isEmpty(this.nota)) {
            ...
            if ("".equals(retorno.toString())) {
                ...
                if (!TSUtil.isEmpty(new RadioPedidoVendaDAO().obterIdExternoInterface(nota))) {
