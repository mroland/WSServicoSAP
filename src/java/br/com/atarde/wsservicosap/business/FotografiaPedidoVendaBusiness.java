...
import br.com.atarde.wsservicosap.dao.FotografiaPedidoVendaDAO;
 ...
 * @author mroland
 */
public class FotografiaPedidoVendaBusiness extends NotaFiscalSaidaBusiness {

    private StringBuilder info;
    private FotografiaNotaFiscalSaidaModel nota;

    public FotografiaPedidoVendaBusiness() {
    }

    public FotografiaPedidoVendaBusiness(FotografiaNotaFiscalSaidaModel model) {
    ...
    public String validar() {
        ...
        if (TSUtil.isEmpty(this.nota)) {
            ...
            if ("".equals(retorno.toString())) {
                ...
                if (!TSUtil.isEmpty(new FotografiaPedidoVendaDAO().obterIdExternoInterface(nota))) {
